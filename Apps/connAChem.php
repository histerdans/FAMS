...
if (isset($_POST['CName'])) {
	...
	echo '<script>alert("Chemical Successfully added to the Farm Store")
var newLocation ="../UserPanel/Agrochem.php";
window.location = newLocation;</script>';
	
}
else
	echo '<script>alert("Chemical insert error. Please Try again!!!")
var newLocation ="../UserPanel/Agrochem.php";
window.location = newLocation;</script>';
}
else echo '<script>alert("Missing Chemical Name. Please Check and Try again!!!")
var newLocation ="../UserPanel/Agrochem.php";
window.location = newLocation;</script>';
}
else
