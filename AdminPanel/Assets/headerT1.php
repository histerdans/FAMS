        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          ...
          <div class="menu_section">
            ...
            <ul class="nav side-menu">
              <li> <?php echo "<a  href=\"../../UserPanel/UserDash.php?FID=$FID\">"; ?> <i class="fa fa-home"></i>Dashboard<span class="fa fa-chevron-left"></span></a>
             ...
             <?php 
              ...
              <li><a><i class="fa fa-table"></i> Farm Accounts <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu" style="display: none">
              ...
              <li><a><i class="fa fa-table"></i> SetFarm <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu" style="display: none">
    ...
    <div class="modal-dialog" >
      <div class="modal-content" >
        ...
        <form id="demo-form2" data-parsley-validate  action="../Apps/connprof.php" name="LoginForm"  method="POST" style="padding: 50px;padding-top:5px; ">
          ...
          <input type="hidden" id="UserID" class="form-control" name="UserID" value="<?php echo $usid;?>" />
